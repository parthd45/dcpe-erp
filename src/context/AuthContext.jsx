...
const mapStudent = (row) => ({
  ...
  category: row.category || 'OPEN / General',
  ...
  score10th: row.score_10th || 'Pending',
  score12th: row.score_12th || 'Pending',
  scoreGrad: row.score_grad || 'Pending',
  scoreAadhaar: row.score_aadhaar || 'Pending',
