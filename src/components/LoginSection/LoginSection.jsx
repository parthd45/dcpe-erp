...
const DEMO_ACCOUNTS = [
  {
    role: 'student',
    label: 'Approved Student (Aarav - DCPE/MCA/2026/0001)',
    email: 'aarav.mca@dcpehvpm.org',
    password: 'password123',
    status: 'approved',
  },
  {
    role: 'student',
    label: 'Pending Student (Rohan - DCPE/MCA/2026/0002)',
    email: 'rohan.patil@dcpehvpm.org',
    password: 'password123',
    status: 'pending',
  },
  {
    role: 'hod',
    label: 'HOD Computer Science (Dr. Thakare)',
  ...
  {
    role: 'hod',
    label: 'HOD Science (Prof. Kulkarni)',
  ...
  {
    role: 'admin',
    label: 'College Administrator / Registrar',
